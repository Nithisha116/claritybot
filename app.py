...
import json
import time
import os # Added os import for potential local testing fallback
...
try:
    ...
    # NOTE: The public key provided in the original code is now REMOVED for security.
    # The key needs to be set securely on the Streamlit Cloud dashboard.
